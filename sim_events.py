...
subscibers = {} #empty, will be added to when needed
...
def subscribe(event_name: str, func) -> None:
    ...
    if event_name not in subscibers :
        subscibers[event_name] = set()
    subscibers[event_name].append(func)
...
def post(event_name: str, data) :
    ...
    for func in subscibers[event_name] :
        func(data)
